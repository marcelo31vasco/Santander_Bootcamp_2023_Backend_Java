...
DENTRO DE UM BLOCO, podemos declarar variáveis e usá-las. Em Java, toda variável tem um tipo que não pode ser mudada, uma vez que declarada.
...
public class Variaveis {
    public static void main(String[] args) {
        int minhaIdade = 32;
        int idade = 3;
        System.out.println("A idade de Marcelo é de " + minhaIdade + " anos.");
